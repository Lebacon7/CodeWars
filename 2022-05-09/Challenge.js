//Remove a space and replace with nothing
const noSpace = x => x.replace(/[' ']/g,'')
console.log(noSpace("I hate my dog!"))
...
const isOddHeavy = n => {
    let countOdd = n.map(x
    let countEven = 0
    n.forEach((ele, i) => {(ele%2!=0)? countOdd++: countEven++;})
    return (countOdd<=countEven)? true: false;
}
console.log(isOddHeavy([,-2,-1,2]))