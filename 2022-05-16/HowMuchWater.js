...
*/
const howMuchWater = (water, load, clothes) => (2*load<=clothes)? 'Too much clothes': (clothes<load)? 'Not enough clothes' :Math.round(100*water*(Math.pow(1.1,(clothes-load))))/100;
